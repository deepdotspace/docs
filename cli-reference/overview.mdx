...
| `login` | Authenticate via GitHub or Google OAuth |
...
| `integrations` / `invoke` | Discover and call third-party integration endpoints |
...
- **`--yes` skips confirmation prompts** on destructive commands (`undeploy`, `domain detach`, `domain buy`).
...
<CardGroup cols={2}>
  <Card title="All commands" icon="terminal" href="/cli-reference/commands">
    Every command, every flag.
  </Card>
  <Card title="Quickstart" icon="rocket" href="/get-started/quickstart">
    Walk through the full dev loop.
  </Card>
</CardGroup>
