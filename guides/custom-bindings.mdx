...
<CardGroup cols={2}>
  <Card title="Worker bindings reference" icon="server" href="/sdk-reference/worker/bindings">
    Full type signatures for `runMigrations`, `meter*`, manifest exports.
  </Card>
  <Card title="Custom domains" icon="globe" href="/guides/custom-domains">
    Attach a real domain to your app.
  </Card>
