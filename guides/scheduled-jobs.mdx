...
<CardGroup cols={2}>
  <Card title="Worker cron reference" icon="server" href="/sdk-reference/worker/cron">
    `CronRoom`, `CronTask`, `buildCronContext`.
  </Card>
  <Card title="Server actions" icon="shield-halved" href="/guides/server-actions">
    Privileged on-demand operations.
  </Card>
  <Card title="External APIs" icon="plug" href="/guides/external-apis">
    Calling third-party APIs from your worker.
  </Card>
</CardGroup>
