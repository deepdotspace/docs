...
<Note>
The SDK lints each schema at boot and prints findings prefixed `[schema-lint]` to the worker console. See [Schema-lint warnings](/sdk-reference/worker/schemas#schema-lint-warnings) for the three shapes and their fixes.
</Note>
