...
<CardGroup cols={2}>
  <Card title="Testing reference" icon="code" href="/sdk-reference/testing">
    `users` fixture, `loadAllTestAccounts`, `ensureStorageState`.
  </Card>
  <Card title="CLI test command" icon="terminal" href="/cli-reference/commands#test">
