...
Returns the storage-layer user, merged with role and credits from the app's users collection.
...
|---|---|---|
| `providers` | `('google' \| 'github' \| 'email')[]` | Restrict available sign-in methods. Default shows all. |
